...
function getMonthlySale(){
    let url = 'dashboard/getMonthlySale';
    let f = {};
...
var chartDele = document.querySelector("#chartD");
if(chartDele != null){
    getMonthlySale();
}

function chartD(resData) {
...
function chartF() {
    var options = {
        ...
        colors: ['#1b4962', '#ffa000', '#11a0fd', '#6F68FE', '#0b2354']
    };
