var myArray = {
    ...
    for (var key in myArray) {
        var data = {
           id: key,
           text: `<span class="color-preview" style="background-color:${key}"></span><span>${myArray[key]}</span>`,
           html: `<span class="color-preview" style="background-color:${key}"></span><span>${myArray[key]}</span>`
        };
    ...
    $(document).ready(function(){
        $("#select2_colorpicker").val($("#select2_colorpicker").attr('data-select')).trigger('change');
    })